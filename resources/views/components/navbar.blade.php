<nav class="bg-white flex flex-col md:flex-row items-center justify-between p-4 px-8 shadow-md font-inter h-20 sticky top-0 z-50">
    <div class="flex items-center mb-4 md:mb-0">
        <img alt="Logo Dinas" class="pl-8 w-[230px] h-[94px]" height="60" src="{{asset('images/logonav.png')}}" width="60"/>
    </div>
    <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-10 text-black px-12">
        ...
        <a class="text-xl hover:text-primary hover:scale-105 transition-transform" href="/taman">Data Taman</a>
    </div>
</nav>